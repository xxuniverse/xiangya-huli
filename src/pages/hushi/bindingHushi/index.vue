  ...
  <div class="containerLogin">
    ...
    <div class="section flex-c" :style="{top:headHeigth+'px'}">
      <div class="box">
        ...
        <div class="title">护士端</div>
        <div class="flex-c">
          <span class="message">如您是护士，需完成微信授权以后，方可接收调度端分配的订单。</span>
        </div>
...
export default {
  ...
  methods: {
    afterLogin() {
      wx.navigateTo({ url: "/pages/hushi/oderForm/main" });
    },
    loginBtn() {
      wx.showLoading({
        title: "加载中"
          ...
          if (res.code) {
            ...
            H.authLogin(header, "POST", data, res => {
              ...
              if (res.data.code == 1) {
                ...
                wx.navigateTo({ url: "/pages/hushi/login/main" });
